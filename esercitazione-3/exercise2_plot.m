...
out1_svg = 'exercise2_1_plot.svg';
out2_svg = 'exercise2_2_plot.svg';
...
fig1 = figure('Name', 'Beat - Modulus', 'NumberTitle', 'off');

plot(t, mag, 'Color', [0.2 0.4 0.8], 'LineWidth', 1.2);
xlabel('Tempo [s]');
ylabel('|x_n|', 'Interpreter', 'tex');
title('Modulo del segnale in funzione del tempo');
grid on;
xlim([t(1) t(end)]);
...
fig2 = figure('Name', 'Beat - Complex Plane', 'NumberTitle', 'off');
...
title('Traiettoria del fasore sul piano complesso');
grid on;
axis equal;
box on;
