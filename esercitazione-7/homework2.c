 ...
 * Exercise: Es7 - Homework 2 - Fast Fourier Transform (FFT)
 * Purpose:  Generate N samples of a sinusoidal signal at f0=2015 Hz (not on
 *           the FFT frequency grid), compute its FFT (radix-2 DIF), save the
 *           index, frequency, real part, imaginary part and modulus of each
 *           spectral sample to a CSV file to observe spectral leakage.
 */
