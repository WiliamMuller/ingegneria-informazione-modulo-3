 ...
 * Exercise: Es7 - Homework 1 - Fast Fourier Transform (FFT)
 * Purpose:  Generate N samples of a sinusoidal signal, compute its FFT
 *           (radix-2 DIF) and save the index, frequency, real part, imaginary
 *           part and modulus of each spectral sample to a CSV file.
 */
