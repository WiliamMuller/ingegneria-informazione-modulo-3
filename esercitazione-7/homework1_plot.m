% Reads FFT.csv and plots the modulus of the FFT vector X vs frequency.
%
...
%% Configuration
filename = 'FFT.csv';
out_pdf  = 'homework1_plot.pdf';
out_svg  = 'homework1_plot.svg';
...
fig = figure('Name', 'FFT - Modulus', 'NumberTitle', 'off');
